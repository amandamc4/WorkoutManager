...
public class WorkoutExerciseDataSource {
    ...
    private String[] allColumns = { MySQLiteHelper.COLUMN_WORKOUTEXERCISEID,
            ...
            MySQLiteHelper.COLUMN_REPS, MySQLiteHelper.COLUMN_WEIGHT};
    ...
    public WorkoutExercise createWorkoutExercise(int exerciseId, int workoutId, String reps, double weight) {
...
//    }
    ...
    private WorkoutExercise cursorToWorkoutExercise(Cursor cursor) {
        WorkoutExercise workoutExercise = new WorkoutExercise();
        workoutExercise.setExerciseName(cursor.getString(0));
        workoutExercise.setWorkoutDay(cursor.getString(1));
        workoutExercise.setWorkoutDescription(cursor.getString(2));
        workoutExercise.setReps(cursor.getString(3));
        workoutExercise.setWeight(cursor.getDouble(4));
        return workoutExercise;
    }
